...
export const Footer = () => {
  ...
  const throwSubscribeError = () => {
    submitRef.current.innerText = "Error";
  };
    ...
    fetch("/subscribe", {
      ...
      .then((response) => {
        response
          .json()
          .then((data) => {
            submitRef.current.innerText = data.success ? "Success" : "Error";
          })
          .catch(throwSubscribeError);
      })
      .catch(throwSubscribeError);
  };
    ...
    <footer className="bg-white">
          ...
          <div className="mt-8 xl:mt-0">
            ...
            <form className="mt-4 sm:flex sm:max-w-md" onSubmit={subscribe}>
              ...
              <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                <button
                  ref={submitRef}
                  className="w-full flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-glenstack-600 hover:bg-glenstack-500 focus:outline-none focus:shadow-outline-glenstack transition duration-150 ease-in-out"
                  type="submit"
                >
                  Subscribe
                </button>
      ...
      <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
        <div className="flex md:order-2">
          ...
          <a
            href="https://instagram.com/glenstack"
            target="_blank"
            rel="noopener noreferrer"
          ...
          {/* <a
            href="https://twitter.com/glenstack"
            target="_blank"
            rel="noopener noreferrer"
            className="ml-6 text-gray-400 hover:text-gray-500"
          >
        ...
        <p className="mt-8 text-base leading-6 text-gray-400 md:mt-0 md:order-1">
          &#xA9; {new Date().getFullYear()} Glenstack Ltd. All rights reserved.
        </p>
      </div>
    </footer>
  );
