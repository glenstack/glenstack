              ...
              <div className="hidden md:absolute md:flex md:items-center md:justify-end md:inset-y-0 md:right-0">
                <span className="inline-flex rounded-md shadow">
                  <a
                    ...
                    className="inline-flex items-center px-4 py-2 border border-transparent text-base leading-6 font-medium rounded-md text-glenstack-600 bg-white hover:text-glenstack-500 focus:outline-none focus:shadow-outline-blue active:bg-gray-50 active:text-glenstack-700 transition duration-150 ease-in-out"
                  >
                    Login
                  </a>
                </span>
                ...
                <div className="rounded-lg bg-white shadow-xs overflow-hidden">
                  ...
                  <div>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="block w-full px-5 py-3 text-center font-medium text-glenstack-600 bg-gray-50 hover:bg-gray-100 hover:text-glenstack-700 focus:outline-none focus:bg-gray-100 focus:text-glenstack-700 transition duration-150 ease-in-out"
                    >
                      Log in
                    </a>
                  </div>
          ...
          <div className="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28">
            <div className="text-center">
              <h2 className="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
                We'll build your application for Web, Android and iOS.{" "}
                <br className="xl:hidden" />
                <span className="text-glenstack-600">Fast.</span>
              </h2>
