    ...
    <View>
      <View className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <View className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <Text className="mt-6 text-center text-3xl leading-9 font-extrabold text-gray-900">
            Sign in to your account
          </Text>
          <Text className="mt-2 text-center text-sm leading-5 text-gray-600 max-w">
            Or{" "}
            <Text className="font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">
        ...
        <View className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <View className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <View>
              <Text className="block text-sm font-medium leading-5 text-gray-700">
                Email address
              </Text>
              <View className="mt-1 rounded-md shadow-sm">
                <TextInput className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
              </View>
            </View>
            ...
            <View className="mt-6 flex flex-row items-center justify-between">
              <View className="flex flex-row items-center">
                <CheckBox />
                <Text className="ml-2 block text-sm leading-5 text-gray-900">
                  Remember me
                </Text>
              </View>
            ...
            {/* <View className="mt-6">
              <View className="relative">
                ...
                <View className="relative flex justify-center text-sm leading-5">
